        ...
        <div className={cn("grid gap-3", isMobile ? "grid-cols-2" : "grid-cols-4")}>
          <div className="rounded-xl bg-white/90 dark:bg-white/10 shadow-sm p-2.5 flex flex-col items-center">
            <div className="flex items-center gap-1">
              ...
              <div className="text-[10px] font-medium">Due Date</div>
            </div>
            <div className="mt-1">
              <div className="bg-indigo-100 dark:bg-indigo-900/50 rounded-full w-12 h-12 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-[9px] text-indigo-400 dark:text-indigo-300">OCT</div>
                  <div className="text-indigo-600 dark:text-indigo-300 font-bold text-sm">15</div>
                </div>
              </div>
            </div>
            <div className="text-[9px] text-indigo-500 dark:text-indigo-400 font-medium mt-1.5">28 weeks to go</div>
          ...
          <div className="rounded-xl bg-white/90 dark:bg-white/10 shadow-sm p-2.5 flex flex-col items-center justify-center">
            <div className="flex items-center gap-1 mb-1.5">
              ...
              <div className="text-[10px] font-medium">Development</div>
            </div>
            <div className="bg-pink-100 dark:bg-pink-900/50 rounded-full w-10 h-10 flex items-center justify-center mb-1.5">
              <span className="text-pink-600 dark:text-pink-300 font-bold text-[10px]">W12</span>
            </div>
          ...
          <div className="rounded-xl bg-white/90 dark:bg-white/10 shadow-sm p-2.5 flex flex-col items-center justify-center">
            <div className="flex items-center gap-1 mb-1.5">
              ...
              <div className="text-[10px] font-medium">Baby Size</div>
            </div>
            ...
            <div className="text-center text-[9px] text-gray-500 dark:text-gray-400">
          ...
          <div className="rounded-xl bg-white/90 dark:bg-white/10 shadow-sm p-2.5 flex flex-col">
            <div className="flex justify-between items-center mb-1">
              <div className="flex items-center gap-1">
                ...
                <span className="text-[10px] font-medium">Kick Counter</span>
              </div>
            </div>
            <div className="flex-1 flex flex-col items-center justify-center">
              <div className="text-3xl font-bold text-red-500 dark:text-red-400 mb-2">{kickCount}</div>
              <div className="text-[9px] text-center text-gray-500 dark:text-gray-400 mb-2">kicks recorded today</div>
              <Button 
                className="w-full bg-red-100 hover:bg-red-200 text-red-500 dark:bg-red-900/30 dark:hover:bg-red-900/50 dark:text-red-300 text-[10px] h-6 mt-auto"
                variant="ghost"
